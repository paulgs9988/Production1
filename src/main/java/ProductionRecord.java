 ...
 * This class represents a Production Record which corresponds to Products that have been
 * Produced.

 * A Production Record includes various information including Prod. Number, ID, Serial Number,
 * Production Date, Number of items produced, and the Product being produced
...
public class ProductionRecord {
     ...
     * @param itemCount holds the count of the number of items of its type "product" that
     *                  have been created
     ...
     * @param productionNumber refers to the order in which this run is being made in referenced
     *                         to others
     * @param productID the Product ID of a Product in the Product Database
     ...
     *      Prod Number: Production Number Product Name: Product's Name Serial Number: Serial Number
     *                   Date: Date Produced
