...
/**
 * This class is for creating Employees and their associated information while interacting with the
 * system.
 * <p>
 * An employee will enter his/her name and password and have a username and email created.</p>
 *
...
public class Employee {
  ...
  /**
   * Determines whether or not the entered password is valid based on the following.
   *
   * <p>-Contains a lowercase letter
   * -Contains a capital letter
   * -Contains a special character
   *
   * @return a bool value as to whether or not the password is valid</p>
   */
